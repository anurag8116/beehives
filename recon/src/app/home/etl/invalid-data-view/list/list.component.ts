...
export class ListComponent implements OnInit, AfterViewChecked {
  ...
  public masterDatas: any = [{masterData: {}}];
  ...
  ngOnInit() {
    this.dtOptions = this.dateTableService.getBasicTable('v1/invaliddataviews?Find=All&start=0&length=100', this.getColumnsDefinition());
  }
  ...
  delete(id: number): void {
    this.httpService.delete('v1/invaliddataviews/' + id, true).subscribe(
      (data: any) => {
  ...
  edit(id: number): void {
    this.router.navigate(['/home/etl', 'invalid-data-view', {outlets: {'fullBodyOutlet': ['form']}}], {queryParams: {id: id}});
  }
  ...
  private getColumnsDefinition(): any[] {
    ...
    columns.push({title: 'Data Source', data: 'invalidDataType'});
    const action = {
  ...
  private onDetailButtonSelect(id: number) {
      this.router.navigate(['/home/etl', 'invalid-data-view', {outlets: {'fullBodyOutlet': ['detail']}}], {queryParams: {id: id}});
  }
}
