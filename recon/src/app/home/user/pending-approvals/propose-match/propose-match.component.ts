...
export class ProposeMatchComponent implements OnInit {
  ...
  public onSubCategotyChange(category: any, subCategory) {
    ...
    const url = 'v1/datatrackers?Find=ForceMatchUnMatchRelaxMatchAndKnockOffView&approvalSubCategoryId=' + subCategory.id + '&operationType=PROPOSE_MATCH';
    ...
    this.httpService.get(url, true).subscribe(
      (data: any) => {
        ...
        const viewDataUrl = 'v1/datatrackers?Find=ForceMatchUnMatchRelaxMatchAndKnockOffData&approvalSubCategoryId=' + subCategory.id + '&operationType=PROPOSE_MATCH';
