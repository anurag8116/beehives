...
export class RuleGroupComonent implements OnInit {
  ...
  public onSubCategotyChange(category: any, subCategory) {
    ...
    const url = 'v1/datatrackers?Find=RuleGroup&approvalSubCategoryId=' + subCategory.id + '&operationType=UPDATE_RULE';
